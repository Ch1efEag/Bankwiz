...
//const loan_at = require("./src/models/loan_at");
...
app.post("/loan", async(req,res) => {
	try{
		...
		// 	alert("Total amount to return : ");
		// 	alert(debt);
		// alert("Total time : ");
		// 	alert(years);
		// 	alert("Amount to return per month : ");
			years = req.body.amount;
...
// app.post("/loan_at", async(req,res) => {
// 	try{
// 		console.log(req.body)
// 		const anumber = req.body.accountNumber;
...
// 				const perm  = (debt/years)/12;
// 				alert(perm);
// 				const loan_n = new loan_at({
// 					accountNumber : anumber,
// 					loan_amount: req.body.amount,
// 					Interest_pm : req.body.type,
// 				})
// 				const abba = await loan_n.save();
